    ...
    <asp:Panel ID="Panel1" runat="server">
        ...
        <td class="body_txt">
            ...
            <td class ="body_txt">
              ...
              <asp:button runat="server" text="Довідник лікарів" BackColor="#0033CC" Font-Names="Arial" Font-Size="Small" ForeColor="#FFFFCC" Width="200px" ID="btnAppointment" PostBackUrl="~/Doctor.aspx" />   
